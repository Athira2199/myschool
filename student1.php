...
<div class="container-log">
  <h2 class="text-centre" style="color:#007E33;">LOGIN
    ...
    <div class="form-group">
      ...
      <p><span class="text-muted" style="padding-left:99px;">Not A Student?</span>
    ...
    $query = mysql_query("SELECT * FROM student WHERE user='$username' and password='$password'");
     if (mysql_num_rows($query) != 0)
    {
      session_start();
      $_SESSION['login_user']=$username; 
      if(isset( $_SESSION['login_user'])){
        echo "<script language='javascript' type='text/javascript'> location.href='StudentHomePage.php' </script>";
      }
      }
      else
      {
