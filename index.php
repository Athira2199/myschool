	...
	<div class="col-md-9 col-md-offset-2">
		<?php
			...
			if(isset($_POST['verifyotp'])) { 
				$otp = $_POST['otp'];
				if($_COOKIE['otp'] == $otp) {
                    // escapeshellcmd('C:/Users/Athira.V.Ajit/PycharmProjects/graphics/venv/face_train.py');
                    // $command = escapeshellcmd('C:/Users/Athira.V.Ajit/PycharmProjects/graphics/venv/face.py');
                    // $output = shell_exec($command);
                    // echo $output;
					echo "<script language='javascript' type='text/javascript'> location.href='FaceScan.php' </script>";
				} else {
