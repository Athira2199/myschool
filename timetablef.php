...
{
echo'<html><head><title>Time Table</title>
...
<td align=center>MONDAY';
  $result= mysql_query("SELECT * FROM sugatha WHERE day='Monday' ");
...
echo'<tr class="danger">
 <td align=center>TUESDAY';
  $result= mysql_query("SELECT * FROM sugatha WHERE day='Tuesday' ");
  while($row = mysql_fetch_assoc($result)) {
echo" <td align=center>".($row["period1"])."<td align=center>".($row["period2"])."<br>
 <td align=center>".($row["period3"])."<br>".
 "<td align=center>".($row["period4"])."<br>".
...
echo'<tr class="info">
 <td align=center>WEDNESDAY';
  $result= mysql_query("SELECT * FROM sugatha WHERE day='Wednesday' ");
  while($row = mysql_fetch_assoc($result)) {
echo" <td align=center>".($row["period1"])."<td align=center>".($row["period2"])."<br>
 <td align=center>".($row["period3"])."<br>".
 "<td align=center>".($row["period4"])."<br>".
...
echo'<tr class="warning">
 <td align=center>THURSDAY';
  $result= mysql_query("SELECT * FROM sugatha WHERE day='Thursday' ");
  while($row = mysql_fetch_assoc($result)) {
echo" <td align=center>".($row["period1"])."<td align=center>".($row["period2"])."<br>
 <td align=center>".($row["period3"])."<br>".
 "<td align=center>".($row["period4"])."<br>".
...
echo'<tr class="active">
 <td align=center>FRIDAY';
  $result= mysql_query("SELECT * FROM sugatha WHERE day='Friday' ");
  while($row = mysql_fetch_assoc($result)) {
echo" <td align=center>".($row["period1"])."<td align=center>".($row["period2"])."<br>
 <td align=center>".($row["period3"])."<br>".
 "<td align=center>".($row["period4"])."<br>".
