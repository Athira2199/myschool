          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
              ...
              <div class="single-widget about">
                ...
                <ul>
                  <li><i class="fa fa-phone"></i> Phone:0471-2312662</li>
                  <li><i class="fa fa-envelope"></i> Email: holyangelsisc@yahoo.co.in</li>
                  <li><i class="fa fa-map-o"></i> Near Nanthancode Watt Lane, Nanthancode, Thiruvananthapuram, Kerala 695003</li>
                </ul>
              </div>
              <!--/ End About -->
            </div>
              ...
              <div class="single-widget newsletter">
                ...
                <div class="mail">
                  <p>Don't miss to  subscribe to our news feed, Get the latest updates from us!</p>
                    <form action="footer.php" method=post action="footer.php">
                    <input type="email" placeholder="Enter your email" name=email>
                    <button class="button" type="submit"><i class="fa fa-envelope"></i></button></form>
                   <?php
            include("connect.php");
              ...
              <div class="bottom-head">
                <div class="row">
                  <div class="col-12">
                    ...
                    <!-- Copyright -->
                    <div class="copyright">
                      <p style="padding-left:31px;">&copy; Copyright 2018 <a href="home.html">Holy Angels ISC School.</a> All Rights Reserved</p>
                    </div>
                    <!--/ End Copyright -->
                  </div>
                </div>
